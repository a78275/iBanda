$(document).ready(function(){
    ...
    fieldHTML += '<div class="w3-col w3-margin-top" style="width:6%"><i class="w3-xxlarge w3-left far fa-keyboard" style="color:#c0b283"/></div><div class="w3-col w3-margin-top" style="width:91%"><input class="w3-input w3-border" type=\'text\' name=\'instrumentos.nome\' placeholder=\'Nome\'/></div>'
